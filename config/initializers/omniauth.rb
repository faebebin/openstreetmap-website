...
microsoft_options = { :name => "microsoft", :scope => "wl.signin,wl.emails" }
...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :microsoft, Settings.microsoft_auth_id, Settings.microsoft_auth_secret, microsoft_options if Settings.key?(:microsoft_auth_id)
